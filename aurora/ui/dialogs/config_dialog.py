...
class ChannelSelectionWidget(QWidget):
    ...
    def __init__(self, channels: List[str], parent=None):
        ...
        # Full list of channels Aurora can handle (hardcoded for packaged version)
        # Based on real end-user files
    ...
    def _reset_default(self):
        default_channels = ["hr_aurora", "ECG", "FBP", "Valsalva"]
        for i in range(self.channel_list.count()):
...
class SimpleConfigTab(QWidget):
    ...
    def _setup_ui(self):
        ...
        info_label = QLabel(
            "These channels will be automatically selected when loading files:"
        )
        info_label.setWordWrap(True)
        channels_layout.addWidget(info_label)

        self.channel_widget = ChannelSelectionWidget(
            self.config.default_visible_channels
        )
    ...
    def get_settings(self) -> Dict[str, Any]:
        ...
        return {"default_visible_channels": self.channel_widget.get_selected_channels()}
...
class ConfigDialog(QDialog):
    ...
    def _save_config(self):
        ...
        try:
            ...
            self.config_manager.config.default_visible_channels = settings[
            ...
            if self.config_manager.save_config():
                ...
                QMessageBox.critical(
                    self, "Error", "Failed to save configuration to file."
                )
