...
# Global instance - will be initialized properly when QApplication exists
plot_style_manager = None

def get_plot_style_manager():
    """Get or create the global PlotStyleManager instance."""
    global plot_style_manager
    if plot_style_manager is None:
        plot_style_manager = PlotStyleManager()
    return plot_style_manager
